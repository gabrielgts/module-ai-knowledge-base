...
namespace Gtstudio\AiKnowledgeBase\Ui\Component\Listing\Column;
 ...
 */
class AiKnowledgeBaseBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'AiKnowledgeBase';

    /**
     * Url paths.
     */
    private const EDIT_URL_PATH = 'ai_knowledge_base/aiknowledgebase/edit';
    private const DELETE_URL_PATH = 'ai_knowledge_base/aiknowledgebase/delete';
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[AiKnowledgeBaseInterface::ENTITY_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = [AiKnowledgeBaseInterface::ENTITY_ID => $item[AiKnowledgeBaseInterface::ENTITY_ID]];
